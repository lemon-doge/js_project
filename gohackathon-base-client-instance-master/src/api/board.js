...
export const scoresWinner111 = (token, game_id, count) => {
  return GET(
    `/hints/best-moves-enemy?game_id=${game_id}&centaur_token=test1&token=${token}&count=${count}&centaur_token=${CENTAUR_TOKEN}`,
    {},
    token
  );
};
